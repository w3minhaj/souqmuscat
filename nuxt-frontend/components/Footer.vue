<template>
  <vs-row
    style="padding: 50px; background-color: rgb(30, 30, 30); color: #f2f2f2"
  >
    <vs-col vs-type="flex" vs-justify="center" vs-align="center" w="6">
      <h2>SouqMuscat.com</h2>
      <p>
        221B Baker St,<br />
      ...
      <div class="center con-avatars" style="display: flex; margin-top: 5px">
        <vs-avatar>
          <svg
        ...
        <vs-avatar style="margin-left: 5px">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
    ...
    <vs-col vs-type="flex" vs-justify="center" vs-align="center" w="6"></vs-col>
  </vs-row>
</template>
